...
export default function DisputePage() {
  ...
  const demandLetter =
    ...
    amountDisputed
      ? getDemandLetterTemplate({
          tenantName: (user as { user_metadata?: { full_name?: string } })?.user_metadata?.full_name || user.email?.split("@")[0] || "Tenant",
      ...
      {step === "home" && (
        <>
          ...
          <button
            type="button"
            onClick={() => goNext("what")}
            className="w-full py-4 rounded-xl bg-cyan-500 text-slate-900 font-semibold hover:bg-cyan-400 mb-3"
          >
            Start
          </button>
          <Link
            ...
            {DISPUTE_OUTCOMES.map((o) => (
              <li key={o.id}>
                <button
                  ...
                  className="w-full flex items-center justify-between p-4 rounded-xl bg-slate-800 border border-slate-700 text-left hover:border-cyan-500/50"
                >
        ...
        <>
          ...
          <div className="space-y-3 mb-6">
            <div className="p-3 rounded-lg bg-slate-800 border border-slate-700">
              ...
              >
                {inspections.length === 0 ? "Link a Proof Pack" : "Change selection"}
              </button>
                ...
                >
                  ...
                  {inspections.map((i) => (
                    <option key={i.id} value={i.id}>
                      {i.address} · {i.type} ({format(new Date(i.startedAt), "MMM d")})
                    </option>
                  ))}
                </select>
              )}
          ...
          <button
            ...
            className="w-full py-3 rounded-lg bg-cyan-500 text-slate-900 font-semibold hover:bg-cyan-400"
          >
            Next: Evidence rules
          </button>
        </>
          ...
          <div className="rounded-xl bg-slate-800 border border-slate-700 p-4 mb-4">
            <div className="flex items-center justify-between mb-2">
              ...
              <button
                type="button"
                onClick={copyLetter}
                className="flex items-center gap-1 px-2 py-1 rounded text-cyan-400 text-sm hover:bg-cyan-500/20"
              >
        ...
        <>
          ...
          <div className="space-y-2 mb-6">
            <a
              ...
              className="flex items-center justify-between p-4 rounded-xl bg-slate-800 border border-slate-700 hover:border-cyan-500/50"
            >
      ...
      {step === "filing" && (
        <>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-between p-4 rounded-xl bg-slate-800 border border-slate-700 hover:border-cyan-500/50 mb-4"
          >
      ...
      {step === "finish" && (
        <>
          ...
          <div className="space-y-3 mb-6">
            <Link
              href="/inspection/new"
              className="block w-full py-3 rounded-lg bg-cyan-500 text-slate-900 font-semibold text-center hover:bg-cyan-400"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 w-full py-3 rounded-lg bg-slate-700 text-white font-medium hover:bg-slate-600"
            >
              Open LTB website
          ...
          <button
            type="button"
            onClick={() => { setStep("home"); setOutcome(""); }}
